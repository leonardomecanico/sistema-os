...
// LISTA DE ID'S PARA SALVAMENTO DE TEXTO
const idsCampos = [
...
// SALVAMENTO AUTOMÁTICO EM TEMPO REAL (CAMPOS DE TEXTO)
...
function carregarDadosSalvos() {
    ...
    const BlackListAssinatura = localStorage.getItem('marlift_assinaturaDataUrl');
    if (BlackListAssinatura) {
        assinaturaDataUrl = BlackListAssinatura;
...
function formatarTempo(totalSegundos) {
    ...
    return `${String(horas).padStart(2,'0')}:${String(minutes).padStart(2,'0')}:${String(segundos).padStart(2,'0')}`;
}
